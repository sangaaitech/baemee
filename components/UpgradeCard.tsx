...
import { ConfettiSvg, ArrowSvg } from "@custom-icons/index";

const UpgradeCard = () => {
  return (
    // <!-- This is an example component -->
    <div className="flex items-center justify-center flex-col min-h-scree">
      <div className="break-inside relative overflow-hidden flex flex-col justify-between space-y-2 text-sm rounded-xl max-w-[23rem] p-4 mb-4 bg-vibrant-200 text-white">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="flex items-center justify-center text-xs font-medium rounded-full px-4 py-2 space-x-1 bg-white text-black">
            <span>Next step</span>
            <ArrowSvg className="stroke-black" />
          </button>
        </div>
      </div>
      <div className="break-inside relative overflow-hidden flex flex-col justify-between space-y-3 text-sm rounded-xl max-w-[23rem] p-4 mb-4 bg-white text-black dark:bg-slate-800 dark:text-white">
        ...
        <div className="flex flex-row items-center space-x-3">
          ...
          <span className="text-base font-medium">
            Upgrade your team for better performance
          </span>
        </div>
        <div>
          {" "}
