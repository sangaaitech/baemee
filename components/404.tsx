    ...
    <div>
      <main className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex-shrink-0 pt-16">
          <div className="mx-auto h-12 w-full">
            <Image
              className="aspect-auto"
              height={100}
              width={100}
              objectFit="contain"
              src="/images/axewhy-colorful-logo.png"
              alt="Axewhy"
            />
          </div>
        </div>
        <div className="max-w-xl mx-auto py-16 sm:py-24">
          <div className="text-center">
            <div className="text-9xl font-semibold bg-gradient-to-r bg-clip-text text-transparent from-indigo-500 via-yellow-400 to-pink-500 animate-text">
              404 error
            </div>
