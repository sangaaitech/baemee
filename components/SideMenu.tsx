  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[calc(100%)] bg-black p-6">
        ...
        <button
          type="button"
          className="hover:text-zing-300 absolute top-5 right-5 z-10 flex h-8 w-8 items-center justify-center text-white dark:text-white dark:hover:text-zinc-200"
          tabIndex={0}
          onClick={() => setMenuIsOpen(false)}
        >
          ...
          <ul>
            <li>
              <a
                ...
                className="group mb-4 flex items-center font-medium text-white hover:text-slate-900 dark:text-slate-400 dark:hover:text-zinc-300 lg:text-sm lg:leading-6"
              >
                <div className="dark:group-hover:highlight-white/10 dark:highlight-white/5 mr-4 rounded-md shadow-sm ring-1 ring-slate-900/5 group-hover:shadow group-hover:shadow-sky-200 group-hover:ring-slate-900/10 dark:bg-slate-700 dark:shadow-none dark:ring-0 dark:group-hover:bg-sky-500 dark:group-hover:shadow-none">
            ...
            <li>
              ...
              >
                <div className="dark:group-hover:highlight-white/10 dark:highlight-white/5 mr-4 rounded-md shadow-sm ring-1 ring-slate-900/5 group-hover:shadow group-hover:shadow-indigo-200 group-hover:ring-slate-900/10 dark:bg-slate-700 dark:shadow-none dark:ring-0 dark:group-hover:bg-indigo-500 dark:group-hover:shadow-none">
                  <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none">
                    <path
                      d="m6 9 6-3 6 3v6l-6 3-6-3V9Z"
                      className="fill-indigo-100 group-hover:fill-indigo-200 dark:fill-slate-300"
                    ></path>
                    <path
                      d="m6 9 6 3v7l-6-3V9Z"
                      className="fill-indigo-300 group-hover:fill-indigo-400 dark:fill-slate-400 dark:group-hover:fill-indigo-300"
                    ></path>
                    <path
                      d="m18 9-6 3v7l6-3V9Z"
                      className="fill-indigo-400 group-hover:fill-indigo-500 dark:fill-slate-500 dark:group-hover:fill-indigo-400"
                    ></path>
                  </svg>
                </div>
                Components
            ...
            <li>
              <a
                ...
                className="group mb-4 flex items-center font-medium text-slate-700 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-300 lg:text-sm lg:leading-6"
              >
                <div className="dark:group-hover:highlight-white/10 dark:highlight-white/5 mr-4 rounded-md shadow-sm ring-1 ring-slate-900/5 group-hover:shadow group-hover:shadow-pink-200 group-hover:ring-slate-900/10 dark:bg-slate-700 dark:shadow-none dark:ring-0 dark:group-hover:bg-pink-500 dark:group-hover:shadow-none">
                  <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M19 12a7 7 0 1 1-14 0 7 7 0 0 1 14 0Z"
                      className="fill-pink-400 group-hover:fill-pink-500 dark:fill-slate-500 dark:group-hover:fill-pink-300"
                    ></path>
                    <path
                      ...
                      className="fill-pink-50 group-hover:fill-pink-100 dark:fill-slate-300 dark:group-hover:fill-white"
                    ></path>
                  </svg>
                </div>
                Screencasts
            ...
            <li>
              <a
                ...
                className="group mb-4 flex items-center font-medium text-slate-700 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-300 lg:text-sm lg:leading-6"
              >
                <div className="dark:group-hover:highlight-white/10 dark:highlight-white/5 mr-4 rounded-md shadow-sm ring-1 ring-slate-900/5 group-hover:shadow group-hover:shadow-blue-200 group-hover:ring-slate-900/10 dark:bg-slate-700 dark:shadow-none dark:ring-0 dark:group-hover:bg-blue-500 dark:group-hover:shadow-none">
                  <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none">
                    <path
                      d="M4 12a7 7 0 0 1 7-7h2a7 7 0 1 1 0 14h-2a7 7 0 0 1-7-7Z"
                      className="fill-blue-400 group-hover:fill-blue-500 dark:fill-slate-500 dark:group-hover:fill-blue-400"
                    ></path>
                    <path
                    ...
                    <path
                      ...
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      className="stroke-blue-200 dark:stroke-slate-300 dark:group-hover:stroke-white"
                    ></path>
                  </svg>
                </div>
                Playground
            ...
            <li>
              ...
              >
                <div className="dark:group-hover:highlight-white/10 dark:highlight-white/10 mr-4 rounded-md shadow-sm ring-1 ring-slate-900/5 group-hover:shadow group-hover:shadow-purple-200 group-hover:ring-slate-900/10 dark:bg-purple-400 dark:shadow-none dark:ring-0 dark:group-hover:bg-purple-400 dark:group-hover:shadow-none">
                  <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none">
                    <path
            ...
            <li>
              <a
                ...
                className="group mb-8 flex items-center font-medium text-slate-700 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-300 lg:text-sm lg:leading-6"
              >
                <div className="dark:group-hover:highlight-white/10 dark:highlight-white/5 mr-4 rounded-md shadow-sm ring-1 ring-slate-900/5 group-hover:shadow group-hover:shadow-violet-200 group-hover:ring-slate-900/10 dark:bg-slate-700 dark:shadow-none dark:ring-0 dark:group-hover:bg-violet-500 dark:group-hover:shadow-none">
                  <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      ...
                      className="fill-violet-400 group-hover:fill-violet-500 dark:fill-slate-500 dark:group-hover:fill-violet-300"
                    ></path>
                    <circle
                      cx="12"
                      cy="11"
                      r="1"
                      className="fill-white dark:fill-slate-300 dark:group-hover:fill-white"
                    ></circle>
                    <circle
                      cx="9"
                      cy="11"
                      r="1"
                      className="fill-violet-200 dark:fill-slate-300 dark:group-hover:fill-white"
                    ></circle>
                    <circle
                      cx="15"
                      cy="11"
            ...
            <li className="mt-12 lg:mt-8">
              ...
              <ul className="space-y-6 border-l border-slate-100 dark:border-slate-700 lg:space-y-2">
                <li>
                  <a
