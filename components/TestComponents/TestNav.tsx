...
const TestNav = () => {
  return (
    <>
      <div className="sticky top-0 z-50 h-20 w-full border-b border-slate-500/20 bg-slate-900/20 backdrop-blur-md backdrop-filter sm:px-9">
        <Popover as="header" className="relative z-10">
            ...
            <div className="flex items-center justify-between py-6 md:justify-between md:space-x-2">
              <div className="flex w-full items-center justify-between md:w-auto lg:w-0 lg:flex-1">
                <a href="#" className="flex flex-1 items-center justify-start">
                  <span className="sr-only">Baemee</span>
                  <img
                  ...
                  <div className="relative">
                    <span className="absolute h-20 w-full bg-white/50" />
                      ...
                      >
                        <Popover.Panel className="absolute z-10 -ml-4 mt-3 w-screen max-w-md transform px-2 sm:px-0 lg:left-1/2 lg:ml-0 lg:-translate-x-1/2">
                          <div className="overflow-hidden rounded-lg border border-gray-600/20 shadow-lg ring-1 ring-black ring-opacity-5">
                            <div className="supports-backdrop-blur:bg-white/60 relative grid gap-6 bg-slate-900/20 px-5 py-6 backdrop-blur-md backdrop-filter duration-200 sm:gap-8 sm:p-8">
                              {solutions.map(item => (
                                <a
                                  key={item.name}
                                  href={item.href}
          ...
          >
            ...
            >
              <div className="overflow-hidden rounded-lg border border-slate-700/80 bg-slate-800/80 shadow-md ring-1 ring-slate-600 ring-opacity-5 backdrop-blur-lg">
