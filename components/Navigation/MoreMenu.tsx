...
export interface MoreMenuProps {
  moreIsOpen: boolean
  setMoreIsOpen: (moreIsOpen: boolean) => void
  //   children: React.ReactNode
}

const MoreMenu = ({ moreIsOpen, setMoreIsOpen }: MoreMenuProps) => {
  return (
    <div
    ...
    >
      ...
      ></div>
      <div className="highlight-white/5 fixed top-4 right-4 z-50 w-full max-w-xs rounded-lg bg-primary p-6 text-base  font-semibold text-slate-400 shadow-lg">
        <button
          type="button"
